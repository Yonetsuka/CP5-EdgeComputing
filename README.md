...
### Observação: Na montagem do Esp foi colocado um display LCD, leds para informar se há algum fator maior ou menor que o normal e usou-se um fotoresistor diferente que não forma incluidos no código final.
